...
const ReturnScanPage = () => {
    ...
    // ตัวอย่างข้อมูลการคืนรถที่สร้างขึ้นเอง
    const sampleBookingData = {
        ...
        endDate: "2024-12-12",
        returnDate: "2024-12-12", // ข้อมูลวันที่คืนรถ
        condition: "Good", // ข้อมูลสภาพของรถ
    };

    useEffect(() => {
        // ตั้งค่า bookingDetails ด้วยข้อมูลการคืนรถที่สร้างขึ้นเอง
    ...
    return (
        <div style={{ minHeight: '100vh', background: '#ffff', padding: '30px 20px', position: 'relative' }}>
                        ...
                        >
                            <div style={{ marginBottom: '20px' }}>
                                ...
                                <Button
                                    type="primary"
                                    onClick={() => {
                                        setIsModalVisible(true); // เปิด Modal แสดงข้อมูลการคืนรถ
                                    }}
                                    style={{
                                        borderRadius: '25px',
                                        marginTop: '15px',
            ...
            {/* Modal แสดงข้อมูลการคืนรถ */}
            <Modal
                title="ข้อมูลการคืนรถ"
                    ...
                    <Button
                        ...
                        onClick={() => {
                            ...
                            Modal.success({
                                ...
                                content: 'คุณได้ยืนยันการคืนรถสำเร็จแล้ว',
                                centered: true,
                            });
                        }}
                    >
            ...
            >
                {bookingDetails ? (
                    <div style={{ textAlign: 'left', lineHeight: '1.8' }}>
                        ...
                        <p><strong>วันที่คืนรถ:</strong> {bookingDetails.returnDate}</p>
                    </div>
                ) : (
                    <p>ไม่พบข้อมูลการคืนรถ</p>
                )}
            </Modal>
        </div>
    );
