...
function Navbar() {
  ...
  return (
    <Layout>
      ...
      >
        {/* Logo */}
        <div className="logo" style={{ color: 'black', fontSize: '18px', fontWeight: 'bold' }}>
          สำนักงาน Anan
        </div>
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: '20px' }}>
          ...
          {/* User Info */}
          {screens.md ? (
            <div style={{ display: 'flex', alignItems: 'center', color: 'black', gap: '10px' }}>
              <div>
                <div style={{ fontSize: '14px', fontWeight: 'bold' }}>
                  {userFullName || 'ผู้ใช้งาน'} {/* ถ้ามีชื่อผู้ใช้ใน state ก็จะแสดงชื่อ */}
                </div>
              </div>
              <Popover content={userMenuContent} trigger="click" placement="bottomRight" arrowPointAtCenter>
